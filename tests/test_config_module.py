...
def test_module_auth_settings_respect_environment(monkeypatch: pytest.MonkeyPatch) -> None:
    """Ensure module auth settings reflect environment overrides after reload."""
    ...
    assert reloaded.AUTH_SETTINGS.as_query_params() == {
        "app_ver": "999",
        "os": "android",
        "os_ver": "42",
        "secret": "secret-value",
