...
class SuccessEnvelopeLike(Protocol):
    """Minimal parsed response shape needed for success-envelope checks."""

    success: Any

    def HasField(self, field_name: str) -> bool:
        """Return whether a protobuf field is populated."""
...
def _has_populated_success(parsed: SuccessEnvelopeLike) -> bool:
